...
/**
 * Implements element canonicalization  strategy for elements excluded
 * from the document subset.
 */
class Sisyphus_C14n_Legacy_Strategy_Element_NotIncluded
    extends Sisyphus_C14n_Legacy_Strategy_Element_ElementAbstract
{
    /**
     * Generates canonical string presentation of an XML Element
     * excluded from the document subset
     *
    ...
    protected function generateOutputString(
        ...
        $nestedString)
    {
        return $namespaceString . $attributeString . $nestedString;
    }
}
